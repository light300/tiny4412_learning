...
#define REAl6410_RAM_BASE         0x50008000

// REAL6410
#define RAM_BASE            REAl6410_RAM_BASE
#define VENDOR_ID           REAl6410_VENDOR_ID
#define PRODUCT_ID          REAl6410_PRODUCT_ID
    ...
    for(bus=busses;bus;bus=bus->next)
    {
        ...
        for(dev=bus->devices;dev;dev=dev->next)
        {
            ...
            &&  PRODUCT_ID==dev->descriptor.idProduct)
            {
                ...
                {
		    usb_detach_kernel_driver_np(hdev,0); //Added By CDPDA Howard
